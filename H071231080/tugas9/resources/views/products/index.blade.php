...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div class="d-flex align-items-center" style="margin: 0 auto; font-family: 'Poppins', sans-serif; margin-top:100px;" >
        <h1 class="me-3">Cookies Collection</h1>
    </div>
</div>
...
<div class="container">
    ...
    <div class="d-flex justify-content-end mt-4 mb-4" style="width: 70%; margin: 0 auto; font-family: 'Poppins', sans-serif;">
        <a href="{{ route('products.create') }}" class="btn btn-primary" style="background-color: burlywood; color:black;">Add Product</a><br>
    </div>
